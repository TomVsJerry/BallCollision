...
public class BallView {
    ...
    private float density     = 1f;//物质密度
    private float friction    = 0f;//摩擦系数
    private float restitution = 1;//0.5f;//恢复系数
    ...
    private void createBody(World world, View view) {
        ...
        //初始化物体的运动行为
        body.setLinearVelocity(new Vec2(random.nextInt(10), random.nextInt(10)));
    ...
    private void initWorldBounds() {
        ...
        fixtureDef.friction = 0f;//摩擦系数
        fixtureDef.restitution = 1f;//恢复系数
        ...
        fixtureDef2.density = 1f;//物质密度
        fixtureDef2.friction = 0f;//摩擦系数
        fixtureDef2.restitution = 1f;//恢复系数
